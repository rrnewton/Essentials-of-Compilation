...
\rn{FIXME: this needs to include the (type \_) form.}
...
\chapter{More coming soon}
  \color{comment-red}{The rest of this book is undergoing some updates; it will be
    released as we go along during the Fall 2016 semester.
    I'm turning on the rest of the book, but read beyond this point at your own
    risk; things may change!
    -Ryan}
%  \end{document}
