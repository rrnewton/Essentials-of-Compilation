...
(\tagbits) and it preserves the sign of the integer. We use the \key{orq}
...
\end{tabular}  \\
%
Here we use the constant $\tagmask$, together with \key{andq}, to {\em mask} off
...
bit pattern $00{\ldots}00111$, applying \code{notq} to obtain
$11{\ldots}11000$, and then applying \code{andq} with the tagged value get the
desired result. \\
%
\begin{tabular}{lll}
\begin{minipage}{0.4\textwidth}
